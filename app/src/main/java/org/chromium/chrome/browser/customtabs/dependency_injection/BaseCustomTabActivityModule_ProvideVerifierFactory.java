...
public final class BaseCustomTabActivityModule_ProvideVerifierFactory implements Factory<Verifier> {
  ...
  public static Verifier provideVerifier(BaseCustomTabActivityModule instance,
    ...
    return Preconditions.checkNotNull(instance.provideVerifier(webApkVerifier, addToHomescreenVerifier, twaVerifier, emptyVerifier), "Cannot return null from a non-@Nullable @Provides method");
  }
}
