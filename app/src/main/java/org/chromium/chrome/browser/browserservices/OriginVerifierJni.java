...
final class OriginVerifierJni implements OriginVerifier.Natives {
  ...
  public long init(OriginVerifier caller, WebContents webContents, Profile profile) {
    return (long)GEN_JNI.org_chromium_chrome_browser_browserservices_OriginVerifier_init(caller, webContents, profile);
  }
  ...
  public boolean verifyOrigin(long nativeOriginVerifier, OriginVerifier caller, String packageName,
    ...
    return (boolean)GEN_JNI.org_chromium_chrome_browser_browserservices_OriginVerifier_verifyOrigin(nativeOriginVerifier, caller, packageName, signatureFingerprint, origin, relationship);
  }

  @Override
  public void destroy(long nativeOriginVerifier, OriginVerifier caller) {
    GEN_JNI.org_chromium_chrome_browser_browserservices_OriginVerifier_destroy(nativeOriginVerifier, caller);
  }
