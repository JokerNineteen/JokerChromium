...
public final class ServiceTabLauncherJni implements ServiceTabLauncher.Natives {
  ...
  public void onWebContentsForRequestAvailable(int requestId, WebContents webContents) {
    GEN_JNI.org_chromium_chrome_browser_ServiceTabLauncher_onWebContentsForRequestAvailable(requestId, webContents);
  }
