...
final class ProcessIdFeedbackSourceJni implements ProcessIdFeedbackSource.Natives {
  ...
  public long getCurrentPid() {
    return (long)GEN_JNI.org_chromium_chrome_browser_feedback_ProcessIdFeedbackSource_getCurrentPid();
  }

  @Override
  public void start(ProcessIdFeedbackSource source) {
    GEN_JNI.org_chromium_chrome_browser_feedback_ProcessIdFeedbackSource_start(source);
  }

  @Override
  public long[] getProcessIdsForType(long nativeProcessIdFeedbackSource,
      ProcessIdFeedbackSource caller, int processType) {
    return (long[])GEN_JNI.org_chromium_chrome_browser_feedback_ProcessIdFeedbackSource_getProcessIdsForType(nativeProcessIdFeedbackSource, caller, processType);
  }
