...
final class SslValidityCheckerJni implements SslValidityChecker.Natives {
  ...
  public String getInvalidSslCertificateErrorMessage(WebContents webContents) {
    return (String)GEN_JNI.org_chromium_chrome_browser_payments_SslValidityChecker_getInvalidSslCertificateErrorMessage(webContents);
  }

  @Override
  public boolean isValidPageInPaymentHandlerWindow(WebContents webContents) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_payments_SslValidityChecker_isValidPageInPaymentHandlerWindow(webContents);
  }
