...
public final class QualityEnforcer_Factory implements Factory<QualityEnforcer> {
  ...
  public QualityEnforcer_Factory(Provider<ChromeActivity<?>> activityProvider,
  ...
  public static QualityEnforcer_Factory create(Provider<ChromeActivity<?>> activityProvider,
      Provider<ActivityLifecycleDispatcher> lifecycleDispatcherProvider,
      Provider<TabObserverRegistrar> tabObserverRegistrarProvider,
      Provider<BrowserServicesIntentDataProvider> intentDataProvider,
      Provider<CustomTabsConnection> connectionProvider, Provider<Verifier> verifierProvider,
  ...
  public static QualityEnforcer newInstance(ChromeActivity<?> activity,
