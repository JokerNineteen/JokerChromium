...
final class UnifiedConsentServiceBridgeJni implements UnifiedConsentServiceBridge.Natives {
  ...
  public boolean isUrlKeyedAnonymizedDataCollectionEnabled(Profile profile) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_signin_UnifiedConsentServiceBridge_isUrlKeyedAnonymizedDataCollectionEnabled(profile);
  }

  @Override
  public void setUrlKeyedAnonymizedDataCollectionEnabled(Profile profile, boolean enabled) {
    GEN_JNI.org_chromium_chrome_browser_signin_UnifiedConsentServiceBridge_setUrlKeyedAnonymizedDataCollectionEnabled(profile, enabled);
  }

  @Override
  public boolean isUrlKeyedAnonymizedDataCollectionManaged(Profile profile) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_signin_UnifiedConsentServiceBridge_isUrlKeyedAnonymizedDataCollectionManaged(profile);
  }
