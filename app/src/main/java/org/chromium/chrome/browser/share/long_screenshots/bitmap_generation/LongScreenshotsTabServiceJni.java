...
final class LongScreenshotsTabServiceJni implements LongScreenshotsTabService.Natives {
  ...
  public void captureTabAndroid(long nativeLongScreenshotsTabService, int tabId,
    ...
    GEN_JNI.org_chromium_chrome_browser_share_long_1screenshots_bitmap_1generation_LongScreenshotsTabService_captureTabAndroid(nativeLongScreenshotsTabService, tabId, webContents, clipX, clipY, clipWidth, clipHeight);
  }
