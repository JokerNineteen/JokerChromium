...
final class PrefetchConfigurationJni implements PrefetchConfiguration.Natives {
  ...
  public boolean isPrefetchingEnabled(ProfileKey key) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_isPrefetchingEnabled(key);
  }

  @Override
  public boolean isEnabledByServer(ProfileKey key) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_isEnabledByServer(key);
  }

  @Override
  public boolean isForbiddenCheckDue(ProfileKey key) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_isForbiddenCheckDue(key);
  }

  @Override
  public boolean isEnabledByServerUnknown(ProfileKey key) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_isEnabledByServerUnknown(key);
  }

  @Override
  public void setPrefetchingEnabledInSettings(ProfileKey key, boolean enabled) {
    GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_setPrefetchingEnabledInSettings(key, enabled);
  }

  @Override
  public boolean isPrefetchingEnabledInSettings(ProfileKey key) {
    return (boolean)GEN_JNI.org_chromium_chrome_browser_offlinepages_prefetch_PrefetchConfiguration_isPrefetchingEnabledInSettings(key);
  }
