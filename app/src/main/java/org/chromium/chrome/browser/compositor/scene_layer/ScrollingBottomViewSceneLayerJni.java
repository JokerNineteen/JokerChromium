...
final class ScrollingBottomViewSceneLayerJni implements ScrollingBottomViewSceneLayer.Natives {
  ...
  public long init(ScrollingBottomViewSceneLayer caller) {
    return (long)GEN_JNI.org_chromium_chrome_browser_compositor_scene_1layer_ScrollingBottomViewSceneLayer_init(caller);
  }
  ...
  public void setContentTree(long nativeScrollingBottomViewSceneLayer,
    ...
    GEN_JNI.org_chromium_chrome_browser_compositor_scene_1layer_ScrollingBottomViewSceneLayer_setContentTree(nativeScrollingBottomViewSceneLayer, caller, contentTree);
  }
  ...
  public void updateScrollingBottomViewLayer(long nativeScrollingBottomViewSceneLayer,
    ...
    GEN_JNI.org_chromium_chrome_browser_compositor_scene_1layer_ScrollingBottomViewSceneLayer_updateScrollingBottomViewLayer(nativeScrollingBottomViewSceneLayer, caller, resourceManager, viewResourceId, shadowHeightPx, xOffset, yOffset, showShadow);
  }
