...
final class SiteEngagementServiceJni implements SiteEngagementService.Natives {
  ...
  public SiteEngagementService siteEngagementServiceForProfile(Profile profile) {
    return (SiteEngagementService)GEN_JNI.org_chromium_chrome_browser_engagement_SiteEngagementService_siteEngagementServiceForProfile(profile);
  }

  @Override
  public void setParamValuesForTesting() {
    GEN_JNI.org_chromium_chrome_browser_engagement_SiteEngagementService_setParamValuesForTesting();
  }

  @Override
  public double getScore(long nativeSiteEngagementServiceAndroid, SiteEngagementService caller,
      String url) {
    return (double)GEN_JNI.org_chromium_chrome_browser_engagement_SiteEngagementService_getScore(nativeSiteEngagementServiceAndroid, caller, url);
  }
  ...
  public void resetBaseScoreForURL(long nativeSiteEngagementServiceAndroid,
    ...
    GEN_JNI.org_chromium_chrome_browser_engagement_SiteEngagementService_resetBaseScoreForURL(nativeSiteEngagementServiceAndroid, caller, url, score);
  }
