...
public final class IdentityServicesProviderJni implements IdentityServicesProvider.Natives {
  ...
  public IdentityManager getIdentityManager(Profile profile) {
    return (IdentityManager)GEN_JNI.org_chromium_chrome_browser_signin_IdentityServicesProvider_getIdentityManager(profile);
  }

  @Override
  public AccountTrackerService getAccountTrackerService(Profile profile) {
    return (AccountTrackerService)GEN_JNI.org_chromium_chrome_browser_signin_IdentityServicesProvider_getAccountTrackerService(profile);
  }

  @Override
  public SigninManager getSigninManager(Profile profile) {
    return (SigninManager)GEN_JNI.org_chromium_chrome_browser_signin_IdentityServicesProvider_getSigninManager(profile);
  }
