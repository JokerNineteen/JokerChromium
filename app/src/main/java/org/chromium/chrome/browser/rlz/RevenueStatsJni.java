...
final class RevenueStatsJni implements RevenueStats.Natives {
  ...
  public void setSearchClient(String client) {
    GEN_JNI.org_chromium_chrome_browser_rlz_RevenueStats_setSearchClient(client);
  }

  @Override
  public void setRlzParameterValue(String rlz) {
    GEN_JNI.org_chromium_chrome_browser_rlz_RevenueStats_setRlzParameterValue(rlz);
  }
