// AudioDecoderInfo.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class AudioDecoderInfo extends org.chromium.mojo.bindings.Struct {
    ...
    private AudioDecoderInfo(int version) {
        super(STRUCT_SIZE, version);
        this.isPlatformDecoder = (boolean) false;
        this.hasDecryptingDemuxerStream = (boolean) false;
    }

    public AudioDecoderInfo() {
        this(0);
    }

    public static AudioDecoderInfo deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static AudioDecoderInfo deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static AudioDecoderInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        AudioDecoderInfo result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new AudioDecoderInfo(elementsOrVersion);
                {
