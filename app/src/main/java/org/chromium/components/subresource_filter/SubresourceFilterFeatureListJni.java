...
final class SubresourceFilterFeatureListJni implements SubresourceFilterFeatureList.Natives {
  ...
  public static final JniStaticTestMocker<SubresourceFilterFeatureList.Natives> TEST_HOOKS = new org.chromium.base.JniStaticTestMocker<org.chromium.components.subresource_filter.SubresourceFilterFeatureList.Natives>() {
    ...
    public void setInstanceForTesting(
        org.chromium.components.subresource_filter.SubresourceFilterFeatureList.Natives instance) {
  ...
  public boolean isEnabled(String featureName) {
    return (boolean)GEN_JNI.org_chromium_components_subresource_1filter_SubresourceFilterFeatureList_isEnabled(featureName);
  }
  ...
  public static SubresourceFilterFeatureList.Natives get() {
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException("No mock found for the native implementation for org.chromium.components.subresource_filter.SubresourceFilterFeatureList.Natives. The current configuration requires all native implementations to have a mock instance.");
      }
    }
