...
final class AppBannerManagerJni implements AppBannerManager.Natives {
  ...
  public static final JniStaticTestMocker<AppBannerManager.Natives> TEST_HOOKS = new org.chromium.base.JniStaticTestMocker<org.chromium.components.webapps.AppBannerManager.Natives>() {
    ...
    public void setInstanceForTesting(
        org.chromium.components.webapps.AppBannerManager.Natives instance) {
  ...
  public String getInstallableWebAppName(WebContents webContents) {
    return (String)GEN_JNI.org_chromium_components_webapps_AppBannerManager_getInstallableWebAppName(webContents);
  }
  ...
  public boolean onAppDetailsRetrieved(long nativeAppBannerManagerAndroid, AppBannerManager caller,
    ...
    return (boolean)GEN_JNI.org_chromium_components_webapps_AppBannerManager_onAppDetailsRetrieved(nativeAppBannerManagerAndroid, caller, data, title, packageName, imageUrl);
  }
  ...
  public void setDaysAfterDismissAndIgnoreToTrigger(int dismissDays, int ignoreDays) {
    GEN_JNI.org_chromium_components_webapps_AppBannerManager_setDaysAfterDismissAndIgnoreToTrigger(dismissDays, ignoreDays);
  }

  @Override
  public void setTimeDeltaForTesting(int days) {
    GEN_JNI.org_chromium_components_webapps_AppBannerManager_setTimeDeltaForTesting(days);
  }

  @Override
  public void setTotalEngagementToTrigger(double engagement) {
    GEN_JNI.org_chromium_components_webapps_AppBannerManager_setTotalEngagementToTrigger(engagement);
  }
  ...
  public static AppBannerManager.Natives get() {
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException("No mock found for the native implementation for org.chromium.components.webapps.AppBannerManager.Natives. The current configuration requires all native implementations to have a mock instance.");
      }
    }
