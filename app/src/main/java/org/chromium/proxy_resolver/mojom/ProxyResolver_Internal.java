...
org.chromium.url.mojom.Url url, org.chromium.network.mojom.NetworkIsolationKey networkIsolationKey, ProxyResolverRequestClient client) {
        ...
        public static ProxyResolverGetProxyForUrlParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new ProxyResolverGetProxyForUrlParams(elementsOrVersion);
                    ...
                    result.client = decoder0.readServiceInterface(24, false, ProxyResolverRequestClient.MANAGER);
                    }
